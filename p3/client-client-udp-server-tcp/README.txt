...
Issues that I ran into: Making it so that the client is able to issue more
                        than one command on each run.
                        I also haven't figured out how to code up to make sure
                        that the server/client has received the whole message
                        I also have not figured out how to make the timeout
                        work for REGISTER command
                        I am sure that there are probably other issues that I
                        have not taken care of yet. Such as possible 
                        misinterpretation of the way to send and receive 
                        some of the commands.
                       
                        
Revisions:

    -added a menu option for the commands instead of having to type
     the input by hand (i.e. REGISTER device_ID IP MAC PORT)                    
